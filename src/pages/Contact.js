            ...
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              <div className="flex">
                <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">
                  <Trans i18nKey="form.contact.title">Send us a message</Trans>
                </h1>
              </div>
              ...
              <div className="my-2 w-1/2 lg:w-2/4">
                ...
                >
                  <Trans i18nKey="form.contact.send-btn">Send Message</Trans>
                </button>
              </div>
            </div>
          </form>
          <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-blue-900 rounded-2xl">
            <div className="flex flex-col text-white">
              <div className="flex my-4 w-2/3 lg:w-3/4">
                ...
                <div className="flex flex-col">
                  <h2 className="text-2xl">
                    <Trans i18nKey="form.address">Office Address</Trans>
                  </h2>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  <h2 className="text-2xl">
                    <Trans i18nKey="form.phone">Call Us</Trans>
                  </h2>
                  <p className="text-gray-400">
                    Tel: <Trans i18nKey="contact.phone">+86 123 456 7890</Trans>
                  </p>

                  <div className="mt-5">
                    <h2 className="text-2xl">
                      <Trans i18nKey="form.email">Email Us</Trans>
                    </h2>
                    <p className="text-gray-400">
                      <Trans i18nKey="contact.email">hi@ceres-ai.co</Trans>
                    </p>
                  </div>
                </div>
              </div>
